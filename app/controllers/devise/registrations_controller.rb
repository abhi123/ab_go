class Devise::RegistrationsController < ApplicationController
  ...
  def create
    build_resource
    #resource.tag_list = "awesome, slick, hefty"
    #resource.skill_list = "joking, clowning, boxing"
    if verify_recaptcha(:model => @user, :message => "Oh! It's error with reCAPTCHA!") && resource.save
      clean_up_passwords(resource)
      respond_with_navigational(resource) { redirect_to(root_path, :notice => "Registered successfully. Please check your mail") }
    else    
